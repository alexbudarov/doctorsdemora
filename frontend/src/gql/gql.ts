...
const documents = {
  ...
  "query DoctorList_DoctorList(\n  $filter: DoctorFilterInput\n  $sort: [DoctorOrderByInput]\n  $page: OffsetPageInput\n) {\n  doctorList(\n    filter: $filter\n    sort: $sort\n    page: $page\n  ) {\n    content {\n      firstName\n      id\n      lastName\n      specialty\n    }\n    totalElements\n  }\n}":
    types.DoctorList_DoctorListDocument,
  "mutation DeleteDoctor_DoctorList($id: ID!) {\n  deleteDoctor(id: $id) \n}":
    types.DeleteDoctor_DoctorListDocument,
  "\n  query userInfo {\n   userInfo {\n     id\n     fullName\n     avatar\n   }\n  }\n":
 ...
 */
export function gql(
  source: "query DoctorList_DoctorList(\n  $filter: DoctorFilterInput\n  $sort: [DoctorOrderByInput]\n  $page: OffsetPageInput\n) {\n  doctorList(\n    filter: $filter\n    sort: $sort\n    page: $page\n  ) {\n    content {\n      firstName\n      id\n      lastName\n      specialty\n    }\n    totalElements\n  }\n}",
): (typeof documents)["query DoctorList_DoctorList(\n  $filter: DoctorFilterInput\n  $sort: [DoctorOrderByInput]\n  $page: OffsetPageInput\n) {\n  doctorList(\n    filter: $filter\n    sort: $sort\n    page: $page\n  ) {\n    content {\n      firstName\n      id\n      lastName\n      specialty\n    }\n    totalElements\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(
  source: "mutation DeleteDoctor_DoctorList($id: ID!) {\n  deleteDoctor(id: $id) \n}",
): (typeof documents)["mutation DeleteDoctor_DoctorList($id: ID!) {\n  deleteDoctor(id: $id) \n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(
