...
import {Edit, EditProps, SimpleForm, TextInput, useNotify, useRedirect, useUpdate,} from "react-admin";
...
export const DoctorEdit = (props: AdvancedEditProps) => {
  const queryOptions = {
    meta: {
      query: DOCTOR,
      resultDataPath: null,
  ...
  return (
    <Edit<ItemType> mutationMode="pessimistic" queryOptions={queryOptions} {...props}>
      <SimpleForm onSubmit={save}>
        ...
        <Secured permission="Doctor.viewSpecialty">
          <EnumInput source="specialty" enumTypeName="Specialty" enum={Specialty}/>
        </Secured>
      </SimpleForm>
    </Edit>
  );
