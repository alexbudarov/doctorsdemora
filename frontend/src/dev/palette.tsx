...
import { NonModalDialogTemplate } from "./NonModalDialogTemplate";
import { useParams } from "react-router";
import { useState } from "react";
import { FileInput } from "../core/components/file/FileInput";
  ...
  <Palette>
    <Category name="App Templates">
      ...
      <Component name="Dialog">
        <Variant name="Modal Dialog" proto={DialogTemplate} previewImagePath="./media/Dialog.svg" />
        <Variant name="Non Modal Dialog" proto={NonModalDialogTemplate} previewImagePath="./media/Dialog.svg" />
      </Component>
    ...
    <Category name="Amplicode Inputs">
      <Component
        name="FileInput"
        docURL="https://marmelab.com/react-admin/FileInput.html"
      >
        <Variant name="create file">
          <FileInput fileIdSource="fileIdSourceName" uploadUrlQuery={gql("")} />
        </Variant>
        <Variant name="edit file">
          <FileInput
            fileIdSource="fileIdSourceName"
            uploadUrlQuery={gql("")}
            downloadUrlQuery={gql("")}
          />
        </Variant>
        <Variant name="fileNameSource">
          <FileInput
            fileIdSource="fileIdSourceName"
            fileNameSource="fileNameSourceName"
            uploadUrlQuery={gql("")}
          />
        </Variant>
    ...
    <Category name="Amplicode Fields">
      <Component
        name="FileField"
        docURL="https://marmelab.com/react-admin/FileField.html"
      >
        <Variant>
          <FileField source="sourceName" downloadUrlQuery={gql("")} />
        </Variant>
      </Component>
    </Category>
    ...
    <Category name="React Admin UI">
      ...
      >
        ...
        <Variant name="Menu.Item">
          <Menu.Item to="/custom-route" primaryText="CustomRoute" placeholder="" />
        </Variant>
      </Component>
      <Component
        name="Title"
